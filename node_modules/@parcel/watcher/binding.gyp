            ...
            "conditions": [
                [
                    'OS=="mac"',
                    {
                        ...
                        "defines": ["WATCHMAN", "BRUTE_FORCE", "FS_EVENTS", "KQUEUE"],
                ...
                [
                    'OS=="linux" or OS=="android"',
                    {
                        ...
                        "defines": ["WATCHMAN", "INOTIFY", "BRUTE_FORCE"],
                    },
                ],
                [
                    'OS=="win"',
                    {
                        ...
                        "defines": ["WATCHMAN", "WINDOWS", "BRUTE_FORCE"],
                        "msvs_settings": {
                            "VCCLCompilerTool": {
                ...
                [
                    'OS=="freebsd"',
                    {
                        ...
                        "defines": ["WATCHMAN", "BRUTE_FORCE", "KQUEUE"],
                    },
                ],
            ],
        }
    ],
    "variables": {"openssl_fips": "", "node_use_dtrace": "false"},
}
